    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="og:image"
            content="https://labs.1a23.com/userpage/images/banner.png"
          />
          <meta
            name="og:description"
            content="Eana’s user page. A simple and rough about-me page heavily inspired by Wikipedia Userboxes."
          ...
          <link
            ...
            sizes="180x180"
            href="./apple-touch-icon.png?v=GvbwNX7r4M"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="32x32"
            href="./favicon-32x32.png?v=GvbwNX7r4M"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="16x16"
            href="./favicon-16x16.png?v=GvbwNX7r4M"
          />
          <link
            rel="mask-icon"
            href="./safari-pinned-tab.svg?v=GvbwNX7r4M"
            color="#303030"
          />
